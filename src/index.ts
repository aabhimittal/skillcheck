...
export { createSandbox, detectContainment, findCanaries, type Canary, type Sandbox } from './probe/sandbox.js';
export { decideInvoke, synthesiseArgs } from './probe/invoke.js';
...
export { bench, renderBench, type BenchResult } from './bench.js';
